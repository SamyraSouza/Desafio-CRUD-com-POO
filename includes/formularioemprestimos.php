...
<form method="post" class="mt-3">
    ...
    <div class="col-md-6">
      <div class="input-group input-group-outline my-3">
      <select style="border:1px solid lightgray; border-radius: 20px; color: gray; margin-right:10px;" name="idCliente" id="">
    ...
    <div class="col-md-6">
      <div class="input-group input-group-outline my-3">
      <select style="border:1px solid lightgray; border-radius: 20px; color: gray; margin-right:10px;" name="ISBN_liv" id="">
