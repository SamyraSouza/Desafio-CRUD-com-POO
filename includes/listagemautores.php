<?php 
    ...
    foreach($autores as $autor){
        ...
        <a href="editarAutores.php?id='.$autor->id.'"><button type="button" class="btn btn-info">Editar</button>

        <a href="excluirAutores.php?id='.$autor->id.'"><button type="button" class="btn btn-danger">Excluir</button>
        </td>

                        </tr>';
    }

    $resultados = strlen($resultados) ? $resultados : '<tr><td colspan="4" class="text-center">Nenhum autor encontrado</td><tr>';
?>
<h1 class="mt-5 text-center mb-3">Autores</h1>
<main>
